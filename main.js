...
mongoose.connect(
  "mongodb+srv://MusQaddu:DuaAlmadinah123@dua-almadinah.w4uzp.mongodb.net/MasterDB"
);
...
app.post("/adminlogin", function (req, res) {
  if (
    req.body.adminUsername == process.env.USER_NAME &&
    req.body.adminPassword == process.env.PASS_WORD
  ) {
    CityDetails.find({}, function (err, cityDetails) {
      res.render("queryRequest", {
        cityDetailsLists: cityDetails,
